...
def main(args):
    ...
    if(Ray_tune):
        args.summary_dir = args.summary_dir + '_K_' + \
            str(K) + '_lr_' + str(args.lr) + '_updts_' + str(args.num_updates)
    ...
    if('MAML' in args.summary_dir):
        ...
        model = REPTILE(sess, args, seed, 64, input_shape)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='One-Class Model agnostic meta learning with MiniImageNet')
    ...
    if(Ray_tune):
        ...
        config['MIN_ocmaml_noBN'] = {
            "dataset": "MIN",
            "filters": "32 32 32 32",
            "kernel_sizes": "3 3 3 3",
            "dense_layers": "",
            "meta_lr": 0.001,
            "lr": tune.grid_search([0.01, 0.001, 0.1]),
            "num_updates": tune.grid_search([5, 1, 3]),
            "bn": "False",
            "meta_epochs": 10000,
            "K": 2,
            "cir_inner_loop": 1.0,
