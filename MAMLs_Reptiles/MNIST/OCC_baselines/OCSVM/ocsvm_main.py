...
def load_MNIST(test_task_idx, val_task_idx, K, cir_train):
    """ load the required MT-MNIST dataset.
        ...
        val_task_idx : int
            index of the meta-validation task (needed only for loading the dataset).
        K : int
    ...
    relevant_test_task_finetune_sets = test_task_finetune_sets[str(K)][str(cir_train)]


    return relevant_test_task_finetune_sets, test_task_test_set
...
def main(args):
    ...
    finetune_sets, test_set = load_MNIST(args.test_task_idx, args.val_task_idx, args.K, args.cir_train)
    ...
    for finetune_set_index, finetune_set in enumerate(finetune_sets):
        ...
        print('finetune_set_index: ', finetune_set_index, 
            ' acc ', acc,
            ' prec ', prec,
            ' rec ', rec,
            ' spec ', spec,
