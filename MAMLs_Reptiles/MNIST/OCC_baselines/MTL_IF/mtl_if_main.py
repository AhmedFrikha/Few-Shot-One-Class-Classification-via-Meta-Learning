...
def main(args):
            ...
            for K in K_list:
                for cir in cir_inner_loop_list:
                    ...
                    if((K==10 and cir ==0.99) or (K<10 and cir not in [0.5, 1.0])):
                        ...
                        X_val_finetune, Y_val_finetune = sample_random_val_finetune_data(val_task, K, cir_val_IF, val_normal_indexes, val_anomalous_indexes)
    ...
    for K in K_list:
        finetune_sets = test_task_finetune_sets[str(K)][str(cir_val_IF)]
