            ...
            for K in K_list:
                for cir in cir_inner_loop_list:
                    ...
                    if((K==10 and cir ==0.99) or (K<10 and cir not in [0.5, 1.0])):
                        ...
                        val_task_summaries, min_val_task_epoch, val_test_loss = model.val_op(X_val_finetune, Y_val_finetune, val_task['test_X'], val_task['test_Y'], K, cir, epoch)
