...
def main(args):
    ...
    elif('SGD' in args.summary_dir):
        from metasgd_class import MetaSGD
        model = MetaSGD(sess, args, seed, 64, input_shape)
...
if __name__ == '__main__':
    ...
    if(Ray_tune):
        ...
        config['CIFAR_oc_metasgd_BN'] = {
            ...
            "anil": "False",
            "seed": 1,
            "summary_dir": "CIFAR_FS_OC_MetaSGD_BN_"
        }
