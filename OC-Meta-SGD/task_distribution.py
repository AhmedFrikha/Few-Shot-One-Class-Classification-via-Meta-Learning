...
class TaskDistribution:
    def __init__(
        ...
        self.task_probabilities = [
            tp / sum_probabilities for tp in task_probabilities]
    ...
    def sample_batch(self, batch_size=None):
        ...
        if self.sample_with_replacement:
            ...
            tmp_batch = np.random.choice(self.tasks, batch_size, replace=False)
...
class TaskAsSequenceOfTasksDistribution(TaskDistribution):
    def __init__(self, task_sequence_object, batch_size):
        ...
        *This object samples `batch_size' sequences from a distribution defined by the TaskAsSequenceOfTasks
        ...
        """
        self.task_sequences_batch = [
            deepcopy(task_sequence_object) for _ in range(batch_size)]
        self.batch_size = batch_size
        self.reset()
